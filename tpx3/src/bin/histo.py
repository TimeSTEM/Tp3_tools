...
ISI_BOX = False
SPIM_PIXELS = 1225
TIME_DELAY = 570 #Peak value of e-photon correlation
...
if ISI_BOX: g2t = numpy.fromfile("g2tH.txt", dtype='int16') #Photon-Photon time difference
if ISI_BOX: g2_total = numpy.fromfile("isi_g2.txt", dtype='int64')
...
if ISI_BOX: cRatio2 = numpy.divide(g2, xT)
...
if ISI_BOX: ax[0].plot(disparray, g2/max(g2), label='Correlated Data (g2)')
...
if ISI_BOX: ax[1].plot(disparray, cRatio2/max(cRatio2), alpha=0.8, ls='--', color='red', lw=1, label='Ratio g2')
