...
pub trait SpecKind {
    ...
    //fn build_main_tdc<V: TimepixRead>(&self, pack: &mut V) -> Result<Self::MainTdc, Tp3ErrorKind>;
...
///
///# Examples
pub fn run_spectrum<V, U, Y>(mut pack: V, ns: U, my_settings: Settings, frame_tdc: PeriodicTdcRef, kind: Y) -> Result<u8, Tp3ErrorKind>
    where V: TimepixRead,
          U: Write,
          Y: GenerateDepth,
